...
- Name: thantana_test.spec.ts >> Thantana automate test >> TCS-SIGNUP-002 การสมัครสมาชิกเมื่อกรอกข้อมูลครบถ้วนและถูกต้องทุกฟิลด์
- Location: tests\thantana_test.spec.ts:9:7
...
Received string:  "https://myprojectfitnessvercal.vercel.app/signin"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "https://myprojectfitnessvercal.vercel.app/signin"
  ...
  - generic [ref=e19]:
    ...
    - generic [ref=e22]:
      ...
      - generic [ref=e37]:
        ...
        - textbox "example@email.com" [ref=e39]: autoSignup01@email.com
      - generic [ref=e40]:
        - generic [ref=e41]:
      ...
      - button "สมัครสมาชิก" [ref=e47] [cursor=pointer]
      - paragraph [ref=e48]:
        - text: มีบัญชีแล้ว?
        - link "เข้าสู่ระบบ" [ref=e49]:
          - /url: /login
  - contentinfo [ref=e50]:
    - generic [ref=e51]:
      - generic [ref=e52]:
