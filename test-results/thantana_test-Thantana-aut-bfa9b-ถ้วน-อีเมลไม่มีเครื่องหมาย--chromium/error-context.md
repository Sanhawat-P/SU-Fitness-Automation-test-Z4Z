...
- Name: thantana_test.spec.ts >> Thantana automate test >> TCS-SIGNUP-011 การสมัครสมาชิกเมื่อกรอกข้อมูลครบถ้วน อีเมลไม่มีเครื่องหมาย "@"
- Location: tests\thantana_test.spec.ts:78:7
...
Locator: getByText(/(@|กรุณา|ต้อง)/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/(@|กรุณา|ต้อง)/i)
    ...
    - generic [ref=e21]:
      - generic [ref=e22]:
        - generic [ref=e23]:
          ...
          - textbox "ชื่อ" [ref=e25]: สมชาย
        - generic [ref=e26]:
          - generic [ref=e27]: นามสกุล
          - textbox "นามสกุล" [ref=e28]: ใจดี
      - generic [ref=e29]:
        - generic [ref=e30]:
          - generic [ref=e31]: ชื่อผู้ใช้
          - textbox "ชื่อผู้ใช้" [ref=e32]: autoSignup04
        - generic [ref=e33]:
          - generic [ref=e34]: เบอร์โทร
          - textbox "เบอร์โทร" [ref=e35]: "0123456789"
      - generic [ref=e36]:
        - generic [ref=e37]: อีเมล
        - textbox "example@email.com" [active] [ref=e38]: autoSignup04email.com
      - generic [ref=e39]:
        - generic [ref=e40]:
          - generic [ref=e41]: รหัสผ่าน
          - textbox "รหัสผ่าน" [ref=e42]: testpass
        - generic [ref=e43]:
          - generic [ref=e44]: ยืนยันรหัสผ่าน
          - textbox "ยืนยันรหัสผ่าน" [ref=e45]: testpass
      - button "สมัครสมาชิก" [ref=e46] [cursor=pointer]
      - paragraph [ref=e47]:
        - text: มีบัญชีแล้ว?
        - link "เข้าสู่ระบบ" [ref=e48] [cursor=pointer]:
          - /url: /login
  - contentinfo [ref=e49]:
    - generic [ref=e50]:
      - generic [ref=e51]:
