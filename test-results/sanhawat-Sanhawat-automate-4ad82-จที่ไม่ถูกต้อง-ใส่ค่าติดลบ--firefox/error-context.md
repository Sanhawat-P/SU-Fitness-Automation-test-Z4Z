...
- Name: sanhawat.spec.ts >> Sanhawat automated test >> Manage Package การแก้ไขราคาแพ็จเกจที่ไม่ถูกต้อง (ใส่ค่าติดลบ)
- Location: tests\sanhawat.spec.ts:42:7
...
- generic [ref=e3]:
  ...
  - generic [ref=e21]:
    ...
    - table [ref=e28]:
      ...
      - rowgroup [ref=e36]:
        - row "1 4 นักเรียน/นักศึกษา -1 บาท ✏️ แก้ไข 🗑️ ลบ" [ref=e37]:
          - cell "1" [ref=e38]
          - cell "4" [ref=e39]
          - cell "นักเรียน/นักศึกษา" [ref=e40]
          - cell "-1 บาท" [ref=e41]
          - cell "✏️ แก้ไข 🗑️ ลบ" [ref=e42]:
            - button "✏️ แก้ไข" [active] [ref=e43] [cursor=pointer]
