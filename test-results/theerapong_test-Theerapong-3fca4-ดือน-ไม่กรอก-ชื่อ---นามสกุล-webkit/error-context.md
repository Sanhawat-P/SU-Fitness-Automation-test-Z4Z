...
- Name: theerapong_test.spec.ts >> Theerapong automated test >> SF-71 สมัครแพ็คเกจนักเรียน/นักศึกษาแบบรายเดือน ไม่กรอก ชื่อ - นามสกุล
- Location: tests\theerapong_test.spec.ts:68:9
...
Call log:
  - waiting for getByRole('button', { name: 'สมัครเลย' }).first()
    - locator resolved to <button disabled type="button" class="rounded-pill px-4 py-2 fw-bold mt-3 btn btn-danger">สมัครเลย</button>
