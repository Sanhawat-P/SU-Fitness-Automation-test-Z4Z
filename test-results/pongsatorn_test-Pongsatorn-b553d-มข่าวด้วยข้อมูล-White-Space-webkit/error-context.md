...
Call log:
  ...
  - waiting for locator('div').filter({ hasText: /^หัวข้อข่าว$/ })
    5 × locator resolved to <div class="mb-3">…</div>
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e24]:
        ...
        - generic [ref=e446]:
          - img "⛔️หยุดให้บริการ⛔️" [ref=e447]
          - generic [ref=e448]:
            - heading "⛔️หยุดให้บริการ⛔️" [level=6] [ref=e449]
            - generic [ref=e450]: 24/12/2568
            - generic [ref=e451]:
              - button "แก้ไข" [ref=e452] [cursor=pointer]
              - button "ลบ" [ref=e453] [cursor=pointer]
        - generic [ref=e455]:
          - img "🔥🔥PROMOTION!!!🔥🔥" [ref=e456]
          - generic [ref=e457]:
            - heading "🔥🔥PROMOTION!!!🔥🔥" [level=6] [ref=e458]
            - generic [ref=e459]: 1/12/2568
            - generic [ref=e460]:
    ...
    - contentinfo [ref=e463]:
      - generic [ref=e464]:
        - generic [ref=e465]:
          ...
          - generic [ref=e469]:
            - generic [ref=e470]:
              - heading "คลับ" [level=6] [ref=e471]
              - list [ref=e472]:
                - listitem [ref=e473]:
                  - button "ข่าวสาร" [ref=e474] [cursor=pointer]
                - listitem [ref=e475]:
                  - button "ตารางเวลา" [ref=e476] [cursor=pointer]
                - listitem [ref=e477]:
                  - button "สมาชิก" [ref=e478] [cursor=pointer]
            - generic [ref=e479]:
              - heading "ติดต่อเรา" [level=6] [ref=e480]
              - list [ref=e481]:
                - listitem [ref=e482]:
                  - button "พูดคุยกับเรา" [ref=e483] [cursor=pointer]
            - generic [ref=e484]:
              - heading "ข้อมูลเพิ่มเติม" [level=6] [ref=e485]
              - list [ref=e486]:
                - listitem [ref=e487]:
                  - button "กฎระเบียบข้อบังคับ" [ref=e488] [cursor=pointer]
                - listitem [ref=e489]:
                  - button "คำถามที่พบบ่อย" [ref=e490] [cursor=pointer]
          - generic [ref=e491]:
            - img "Logo 2" [ref=e492]
            - generic [ref=e493]:
