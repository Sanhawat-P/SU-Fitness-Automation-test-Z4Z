...
- Name: pongsatorn_test.spec.ts >> Pongsatorn automated test >> TCS-NEWS-023 เพิ่มข่าวด้วยข้อมูลที่ไม่ใส่เนื้อหาข่าว
- Location: tests\pongsatorn_test.spec.ts:110:9
...
Locator: locator('div').filter({ hasText: /^เนื้อหาข่าว$/ })
Expected substring: "กรุณาระบุเนื้อหาข่าว"
Received string:    "เนื้อหาข่าว"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^เนื้อหาข่าว$/ })
    9 × locator resolved to <div class="mb-3">…</div>
      - unexpected value "เนื้อหาข่าว"
    ...
    - generic [ref=e21]:
      ...
      - generic [ref=e24]:
        ...
        - generic [ref=e33]:
          ...
          - textbox "รายละเอียดข่าว..." [active] [ref=e35]
        - generic [ref=e36]:
          - generic [ref=e38]:
